...
| `PUPA_LUCI_LIVELLO_1`..`_3` (2026-09-19) | 3-way exclusive | **Shift+1 / Shift+2 / Shift+3** show | Lights intensity ceiling x0.35 / x0.70 / x1.00 (default 2) - same "most recently shown wins" as CALM. Read by `lights/pupa_luci.py`. (Ctrl/Alt + function keys do NOT work on this OBS/keyboard setup; Shift + F-key and Ctrl + letter do.) |
